...
export type PropsExtended<Props, Msg extends Message = Message, S = {}> = Props & {
	...
	/** Key (unique relative to parent) used for indexing internal props cache and reconciliation */
	key?: string
}

export type MergedPropsExt<P, M extends Message, DP extends Partial<P>> = (
...
export type Component<P extends Obj = Obj> = ((props: P & { key: string, children?: VNode[] }) => JSX.Element /*AsyncGenerator<JSX.Element>*/)
